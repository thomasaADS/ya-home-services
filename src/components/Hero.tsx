...
const slogans = [
  ...
  'יא, הבעל אמר שהוא יתקן את זה — זה היה לפני שנתיים.',
  'יא, התקרה מטפטפת! — לא, זה לא גשם של ברכה.',
  'יא, השכן שלי מתקן לבד — עכשיו הוא צריך שני תיקונים.',
  'יא, אמרו לי שזה קל — עכשיו אין לי מים בבית.',
]
