              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {reasons.map((reason, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-white rounded-2xl p-5 border border-border hover:shadow-card-hover transition-shadow duration-200"
                    >
                      <div className="w-11 h-11 bg-navy/5 rounded-xl flex items-center justify-center mb-4">
