            ...
            {services.slice(0, 2).map((service, index) => (
              <Link
                ...
                className={`group relative overflow-hidden rounded-2xl sm:rounded-3xl block h-64 sm:h-72 ${
                  index === 0 ? 'lg:col-span-2 lg:row-span-2 lg:h-full lg:min-h-[calc(100%)]' : 'lg:col-span-2 lg:h-72'
                }`}
              >
                <Image
                  src={service.image}
                ...
                <div className="absolute bottom-0 right-0 left-0 p-5 sm:p-7">
                  ...
                  <div className="flex items-center gap-1.5 text-white/70 text-sm font-medium mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    פרטים נוספים
                    <ArrowLeft className="w-4 h-4" />
                  </div>
                </div>
              ...
              >
                ...
                <div className="absolute bottom-0 right-0 left-0 p-4 sm:p-5">
                  <div className="flex items-center gap-2 mb-1.5">
                    <service.icon className="w-4 h-4 text-blue-light" />
                  </div>
                  <h3 className="text-white font-bold text-base">
                    {service.title}
                  </h3>
                  <div className="flex items-center gap-1.5 text-white/70 text-sm font-medium mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    פרטים נוספים
                    <ArrowLeft className="w-4 h-4" />
                  </div>
                </div>
