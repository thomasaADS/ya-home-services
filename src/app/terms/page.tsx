      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="prose prose-lg max-w-none text-text-primary leading-relaxed space-y-6">
            ...
            <p>
              השירותים המוצעים באתר כוללים, בין היתר: אינסטלציה, שיפוצים כלליים, התקנת רהיטים, שירותי הנדי מן, התקנת גופי תאורה, תליית תמונות ואביזרים, ופתרונות תחזוקה לבית.
            </p>
            <p>
